		...
		if(!rs.isBeforeFirst())
			...
			else
			{
				   ...
				   if(!(s1==idd)&&(s2==passd))
					...
					stmt1=con.prepareStatement("select * from studentforr where branch='"+branchh+"'");
						...
						if(!rs1.isBeforeFirst())
							{
								...
								{	
									...
									out.print("<table border='1' cellpadding='2' width='100%'>");  
												out.print("<tr><th>id</th><th>rollno</th><th>sname</th><th>pswd</th><th>block</th><th>floor</th><th>appliance</th><th>complaint</th><th>status</th><th>date</th><th>branch</th> </tr>");
													while(rs1.next())
			{

					out.print("<tr><td>"+rs1.getString(1)+"</td><td>"+rs1.getString(2)+"</td><td>"+rs1.getString(3)+"</td><td>"+rs1.getString(4)+"</td><td>"+rs1.getString(5)+"</td><td>"+rs1.getString(6)+"</td><td>"+rs1.getString(7)+"</td><td>"+rs1.getString(8)+"</td><td>"+rs1.getString(9)+"</td><td>"+rs1.getString(10)+"</td><td>"+rs1.getString(11)+"</td></tr>");		
			}
